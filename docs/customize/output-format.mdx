...
With [this example](https://github.com/leoning60/browsernode/blob/main/examples/features/custom_output.ts) you can define what output format the agent should return to you.
